 ...
 */
	function testUrlGenerationWithAdminPrefix() {
		...
		Router::setRequestInfo(array(
			array(
				'pass' => array(), 'action' => 'admin_index', 'plugin' => null, 'controller' => 'suscriptions',
				'admin' => true, 'url' => array('url' => 'admin/suscriptions/index/page:2'),
			),
			array(
				'base' => '/magazine', 'here' => '/magazine/admin/suscriptions/index/page:2',
		...
		$expected = '/magazine/admin/suscriptions/index/page:3';
		$this->assertEqual($result, $expected);

		Router::reload();
		Router::connect('/admin/suscriptions/:action/*', array('controller' => 'subscribe', 'admin' => true, 'prefix' => 'admin'));
		Router::parse('/');
		Router::setRequestInfo(array(
			array(
				'pass' => array(), 'action' => 'admin_index', 'plugin' => null, 'controller' => 'subscribe',
				'admin' => true, 'url' => array('url' => 'admin/suscriptions/edit/1')
			),
			array(
				'base' => '/magazine', 'here' => '/magazine/admin/suscriptions/edit/1',
				'webroot' => '/magazine/', 'passedArgs' => array('page' => 2), 'namedArgs' => array('page' => 2),
			)
		));

		$result = Router::url(array('action' => 'edit', 1));
		$expected = '/magazine/admin/suscriptions/edit/1';
		$this->assertEqual($result, $expected);
